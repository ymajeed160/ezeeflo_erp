...
const reportRegistry = {
  ...
  // ========================
  'pos-daily-sales': {
    procedure: 'sp_Report_POS_DailySales',
    permission: 'pos.view_reports',
    title: 'POS Daily Sales',
    category: 'pos',
    params: ['p_DateFrom', 'p_DateTo', 'p_TerminalId', 'p_Page', 'p_PageSize'],
  },
  'pos-sales-by-cashier': {
    procedure: 'sp_Report_POS_SalesByCashier',
    permission: 'pos.view_reports',
    title: 'POS Sales by Cashier',
    category: 'pos',
    params: ['p_DateFrom', 'p_DateTo', 'p_Page', 'p_PageSize'],
  },
  'pos-sales-by-terminal': {
    procedure: 'sp_Report_POS_SalesByTerminal',
    permission: 'pos.view_reports',
    title: 'POS Sales by Terminal',
    category: 'pos',
    params: ['p_DateFrom', 'p_DateTo', 'p_Page', 'p_PageSize'],
  },
  'pos-sales-by-item': {
    procedure: 'sp_Report_POS_SalesByItem',
    permission: 'pos.view_reports',
    title: 'POS Sales by Item',
    category: 'pos',
    params: ['p_DateFrom', 'p_DateTo', 'p_CategoryId', 'p_Page', 'p_PageSize'],
  },
  'pos-sales-by-category': {
    procedure: 'sp_Report_POS_SalesByCategory',
    permission: 'pos.view_reports',
    title: 'POS Sales by Category',
    category: 'pos',
    params: ['p_DateFrom', 'p_DateTo'],
  },
  'pos-sales-by-customer': {
    procedure: 'sp_Report_POS_SalesByCustomer',
    permission: 'pos.view_reports',
    title: 'POS Sales by Customer',
    category: 'pos',
    params: ['p_DateFrom', 'p_DateTo', 'p_Page', 'p_PageSize'],
  },
  'pos-payment-summary': {
    procedure: 'sp_Report_POS_PaymentSummary',
    permission: 'pos.view_reports',
    title: 'POS Payment Summary',
    category: 'pos',
    params: ['p_DateFrom', 'p_DateTo', 'p_TerminalId'],
  },
  'pos-cashier-session': {
    procedure: 'sp_Report_POS_CashierSession',
    permission: 'pos.view_reports',
    title: 'POS Cashier Session Report',
    category: 'pos',
    params: ['p_SessionId'],
  },
  'pos-cash-variance': {
    procedure: 'sp_Report_POS_CashVariance',
    permission: 'pos.view_reports',
    title: 'POS Cash Variance Report',
    category: 'pos',
    params: ['p_DateFrom', 'p_DateTo', 'p_TerminalId'],
  },
  'pos-returns': {
    procedure: 'sp_Report_POS_Returns',
    permission: 'pos.view_reports',
    title: 'POS Returns Report',
    category: 'pos',
    params: ['p_DateFrom', 'p_DateTo', 'p_Page', 'p_PageSize'],
  },
  'pos-discounts': {
    procedure: 'sp_Report_POS_Discounts',
    permission: 'pos.view_reports',
  ...
  'pos-tax': {
    procedure: 'sp_Report_POS_Tax',
    permission: 'pos.view_reports',
    title: 'POS Tax Report',
    category: 'pos',
    params: ['p_DateFrom', 'p_DateTo'],
  },
  'pos-hourly-sales': {
    procedure: 'sp_Report_POS_HourlySales',
    permission: 'pos.view_reports',
    title: 'POS Hourly Sales',
    category: 'pos',
    params: ['p_DateFrom', 'p_DateTo', 'p_TerminalId'],
  },
  'pos-top-items': {
    procedure: 'sp_Report_POS_TopItems',
    permission: 'pos.view_reports',
    title: 'POS Top Selling Items',
    category: 'pos',
    params: ['p_DateFrom', 'p_DateTo', 'p_Limit'],
  },
  'pos-stock-sold': {
    procedure: 'sp_Report_POS_StockSold',
    permission: 'pos.view_reports',
    title: 'POS Stock Sold',
    category: 'pos',
    params: ['p_DateFrom', 'p_DateTo', 'p_WarehouseId'],
  },
};
