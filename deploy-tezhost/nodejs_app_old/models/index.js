...
const PosTerminalUser = require('./PosTerminalUser');
const PosSession = require('./PosSession');
const PosSale = require('./PosSale');
const PosSaleLine = require('./PosSaleLine');
const PosPayment = require('./PosPayment');
const PosHeldOrder = require('./PosHeldOrder');
const PosCashMovement = require('./PosCashMovement');
const PosReturn = require('./PosReturn');
const PosReturnLine = require('./PosReturnLine');
const PosSubscriptionUsage = require('./PosSubscriptionUsage');
...
// ============================================================
// POS Module Associations
// ============================================================

// PosTerminal -> Tenant
Tenant.hasMany(PosTerminal, { foreignKey: 'tenantId', sourceKey: 'id' });
PosTerminal.belongsTo(Tenant, { foreignKey: 'tenantId', targetKey: 'id' });

// PosTerminal -> Warehouse
Warehouse.hasMany(PosTerminal, { foreignKey: 'warehouseId' });
PosTerminal.belongsTo(Warehouse, { foreignKey: 'warehouseId', as: 'warehouse' });

// PosTerminal -> Account (Cash)
Account.hasMany(PosTerminal, { foreignKey: 'defaultCashAccountId' });
PosTerminal.belongsTo(Account, { foreignKey: 'defaultCashAccountId', as: 'cashAccount' });

// PosTerminal -> Account (Bank)
Account.hasMany(PosTerminal, { foreignKey: 'defaultBankAccountId' });
PosTerminal.belongsTo(Account, { foreignKey: 'defaultBankAccountId', as: 'bankAccount' });

// PosTerminal -> User (createdBy)
User.hasMany(PosTerminal, { foreignKey: 'createdBy' });
PosTerminal.belongsTo(User, { foreignKey: 'createdBy', as: 'creator' });
User.hasMany(PosTerminal, { foreignKey: 'updatedBy' });
PosTerminal.belongsTo(User, { foreignKey: 'updatedBy', as: 'updater' });

// PosTerminal <-> PosTerminalUser <-> User (M2M assignment)
PosTerminal.hasMany(PosTerminalUser, { foreignKey: 'terminalId', as: 'userAssignments' });
PosTerminalUser.belongsTo(PosTerminal, { foreignKey: 'terminalId', as: 'terminal' });
User.hasMany(PosTerminalUser, { foreignKey: 'userId', as: 'posTerminalAssignments' });
PosTerminalUser.belongsTo(User, { foreignKey: 'userId', as: 'user' });

// PosSession -> Tenant
Tenant.hasMany(PosSession, { foreignKey: 'tenantId', sourceKey: 'id' });
PosSession.belongsTo(Tenant, { foreignKey: 'tenantId', targetKey: 'id' });

// PosSession -> PosTerminal
PosTerminal.hasMany(PosSession, { foreignKey: 'terminalId', as: 'sessions' });
PosSession.belongsTo(PosTerminal, { foreignKey: 'terminalId', as: 'terminal' });

// PosSession -> User (cashier)
User.hasMany(PosSession, { foreignKey: 'userId', as: 'posSessions' });
PosSession.belongsTo(User, { foreignKey: 'userId', as: 'cashier' });

// PosSession -> Warehouse
Warehouse.hasMany(PosSession, { foreignKey: 'warehouseId' });
PosSession.belongsTo(Warehouse, { foreignKey: 'warehouseId', as: 'warehouse' });

// PosSession -> User (manager approval)
User.hasMany(PosSession, { foreignKey: 'managerApprovedBy', as: 'approvedSessions' });
PosSession.belongsTo(User, { foreignKey: 'managerApprovedBy', as: 'manager' });

// PosSession -> User (createdBy)
User.hasMany(PosSession, { foreignKey: 'createdBy' });
PosSession.belongsTo(User, { foreignKey: 'createdBy', as: 'creator' });

// PosSale -> Tenant
Tenant.hasMany(PosSale, { foreignKey: 'tenantId', sourceKey: 'id' });
PosSale.belongsTo(Tenant, { foreignKey: 'tenantId', targetKey: 'id' });

// PosSale -> PosTerminal
PosTerminal.hasMany(PosSale, { foreignKey: 'terminalId', as: 'sales' });
PosSale.belongsTo(PosTerminal, { foreignKey: 'terminalId', as: 'terminal' });

// PosSale -> PosSession
PosSession.hasMany(PosSale, { foreignKey: 'sessionId', as: 'sales' });
PosSale.belongsTo(PosSession, { foreignKey: 'sessionId', as: 'session' });

// PosSale -> User
User.hasMany(PosSale, { foreignKey: 'userId', as: 'posSales' });
PosSale.belongsTo(User, { foreignKey: 'userId', as: 'cashier' });
User.hasMany(PosSale, { foreignKey: 'cancelledBy' });
PosSale.belongsTo(User, { foreignKey: 'cancelledBy', as: 'cancelledByUser' });
User.hasMany(PosSale, { foreignKey: 'createdBy' });
PosSale.belongsTo(User, { foreignKey: 'createdBy', as: 'creator' });

// PosSale -> Customer
Customer.hasMany(PosSale, { foreignKey: 'customerId' });
PosSale.belongsTo(Customer, { foreignKey: 'customerId', as: 'customer' });

// PosSale -> Warehouse
Warehouse.hasMany(PosSale, { foreignKey: 'warehouseId' });
PosSale.belongsTo(Warehouse, { foreignKey: 'warehouseId', as: 'warehouse' });

// PosSale -> JournalEntry
JournalEntry.hasMany(PosSale, { foreignKey: 'journalEntryId' });
PosSale.belongsTo(JournalEntry, { foreignKey: 'journalEntryId', as: 'journalEntry' });

// PosSale -> PosSaleLine (One-to-Many)
PosSale.hasMany(PosSaleLine, { foreignKey: 'posSaleId', as: 'lines' });
PosSaleLine.belongsTo(PosSale, { foreignKey: 'posSaleId', as: 'sale' });

// PosSaleLine -> Item
Item.hasMany(PosSaleLine, { foreignKey: 'itemId' });
PosSaleLine.belongsTo(Item, { foreignKey: 'itemId', as: 'item' });

// PosSale -> PosPayment (One-to-Many)
PosSale.hasMany(PosPayment, { foreignKey: 'posSaleId', as: 'payments' });
PosPayment.belongsTo(PosSale, { foreignKey: 'posSaleId', as: 'sale' });

// PosPayment -> Account
Account.hasMany(PosPayment, { foreignKey: 'accountId' });
PosPayment.belongsTo(Account, { foreignKey: 'accountId', as: 'account' });

// PosHeldOrder -> Tenant
Tenant.hasMany(PosHeldOrder, { foreignKey: 'tenantId', sourceKey: 'id' });
PosHeldOrder.belongsTo(Tenant, { foreignKey: 'tenantId', targetKey: 'id' });

// PosHeldOrder -> PosTerminal
PosTerminal.hasMany(PosHeldOrder, { foreignKey: 'terminalId', as: 'heldOrders' });
PosHeldOrder.belongsTo(PosTerminal, { foreignKey: 'terminalId', as: 'terminal' });

// PosHeldOrder -> PosSession
PosSession.hasMany(PosHeldOrder, { foreignKey: 'sessionId', as: 'heldOrders' });
PosHeldOrder.belongsTo(PosSession, { foreignKey: 'sessionId', as: 'session' });

// PosHeldOrder -> User
User.hasMany(PosHeldOrder, { foreignKey: 'userId' });
PosHeldOrder.belongsTo(User, { foreignKey: 'userId', as: 'cashier' });

// PosHeldOrder -> Customer
Customer.hasMany(PosHeldOrder, { foreignKey: 'customerId' });
PosHeldOrder.belongsTo(Customer, { foreignKey: 'customerId', as: 'customer' });

// PosHeldOrder -> PosSale (optional - when converted)
PosSale.hasMany(PosHeldOrder, { foreignKey: 'posSaleId' });
PosHeldOrder.belongsTo(PosSale, { foreignKey: 'posSaleId', as: 'convertedSale' });

// PosCashMovement -> Tenant
Tenant.hasMany(PosCashMovement, { foreignKey: 'tenantId', sourceKey: 'id' });
PosCashMovement.belongsTo(Tenant, { foreignKey: 'tenantId', targetKey: 'id' });

// PosCashMovement -> PosTerminal
PosTerminal.hasMany(PosCashMovement, { foreignKey: 'terminalId', as: 'cashMovements' });
PosCashMovement.belongsTo(PosTerminal, { foreignKey: 'terminalId', as: 'terminal' });

// PosCashMovement -> PosSession
PosSession.hasMany(PosCashMovement, { foreignKey: 'sessionId', as: 'cashMovements' });
PosCashMovement.belongsTo(PosSession, { foreignKey: 'sessionId', as: 'session' });

// PosCashMovement -> User
User.hasMany(PosCashMovement, { foreignKey: 'userId' });
PosCashMovement.belongsTo(User, { foreignKey: 'userId', as: 'cashier' });

// PosReturn -> Tenant
Tenant.hasMany(PosReturn, { foreignKey: 'tenantId', sourceKey: 'id' });
PosReturn.belongsTo(Tenant, { foreignKey: 'tenantId', targetKey: 'id' });

// PosReturn -> PosTerminal
PosTerminal.hasMany(PosReturn, { foreignKey: 'terminalId', as: 'returns' });
PosReturn.belongsTo(PosTerminal, { foreignKey: 'terminalId', as: 'terminal' });

// PosReturn -> PosSession
PosSession.hasMany(PosReturn, { foreignKey: 'sessionId', as: 'returns' });
PosReturn.belongsTo(PosSession, { foreignKey: 'sessionId', as: 'session' });

// PosReturn -> User
User.hasMany(PosReturn, { foreignKey: 'userId', as: 'posReturns' });
PosReturn.belongsTo(User, { foreignKey: 'userId', as: 'cashier' });
User.hasMany(PosReturn, { foreignKey: 'createdBy' });
PosReturn.belongsTo(User, { foreignKey: 'createdBy', as: 'creator' });

// PosReturn -> Customer
Customer.hasMany(PosReturn, { foreignKey: 'customerId' });
PosReturn.belongsTo(Customer, { foreignKey: 'customerId', as: 'customer' });

// PosReturn -> PosSale (original)
PosSale.hasMany(PosReturn, { foreignKey: 'originalSaleId', as: 'returns' });
PosReturn.belongsTo(PosSale, { foreignKey: 'originalSaleId', as: 'originalSale' });

// PosReturn -> JournalEntry
JournalEntry.hasMany(PosReturn, { foreignKey: 'journalEntryId' });
PosReturn.belongsTo(JournalEntry, { foreignKey: 'journalEntryId', as: 'journalEntry' });

// PosReturn -> PosReturnLine (One-to-Many)
PosReturn.hasMany(PosReturnLine, { foreignKey: 'posReturnId', as: 'lines' });
PosReturnLine.belongsTo(PosReturn, { foreignKey: 'posReturnId', as: 'return' });

// PosReturnLine -> PosSaleLine (original)
PosSaleLine.hasMany(PosReturnLine, { foreignKey: 'originalSaleLineId' });
PosReturnLine.belongsTo(PosSaleLine, { foreignKey: 'originalSaleLineId', as: 'originalSaleLine' });

// PosReturnLine -> Item
Item.hasMany(PosReturnLine, { foreignKey: 'itemId' });
PosReturnLine.belongsTo(Item, { foreignKey: 'itemId', as: 'item' });

// PosSubscriptionUsage -> Tenant
Tenant.hasMany(PosSubscriptionUsage, { foreignKey: 'tenantId', sourceKey: 'id' });
PosSubscriptionUsage.belongsTo(Tenant, { foreignKey: 'tenantId', targetKey: 'id' });
