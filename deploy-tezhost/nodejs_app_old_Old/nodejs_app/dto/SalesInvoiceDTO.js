...
class SalesInvoiceDTO {
  ...
  static toDetail(record) {
    return {
      ...
      customerId: record.customerId,
      customerName: record.customer ? record.customer.name : '',
      customerTaxNumber: record.customer ? record.customer.taxNumber : '',
      customerVatNumber: record.customer ? record.customer.vatNumber : '',
      customerEmail: record.customer ? record.customer.email : '',
      customerPhone: record.customer ? record.customer.phone : '',
      customerBillingAddress: record.customer ? record.customer.billingAddress : '',
      customerCity: record.customer ? record.customer.city : '',
      customerState: record.customer ? record.customer.state : '',
      customerCountry: record.customer ? record.customer.country : '',
      customerPostalCode: record.customer ? record.customer.postalCode : '',
      customerAccountId: record.customerAccountId,
