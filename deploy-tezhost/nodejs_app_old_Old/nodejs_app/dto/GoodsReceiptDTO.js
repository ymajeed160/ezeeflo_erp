...
class GoodsReceiptDTO {
  constructor(data) {
    ...
    this.supplierPhone = data.supplier ? data.supplier.phone : null;
    this.supplierEmail = data.supplier ? data.supplier.email : null;
    this.supplierTaxNumber = data.supplier ? data.supplier.taxNumber : null;
