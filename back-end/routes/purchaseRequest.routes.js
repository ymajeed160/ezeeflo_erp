...
router.post('/:id/restore', authenticate, authorize('purchaserequest.edit'), controller.restore);
router.patch('/:id/cancel', authenticate, authorize('purchaserequest.edit'), controller.cancel);
