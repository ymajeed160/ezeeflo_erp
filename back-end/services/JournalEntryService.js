...
class JournalEntryService {
  ...
  async postEntry(id, tenantId, userId, transaction = null) {
    const entry = await journalEntryRepository.findByIdWithLines(id, tenantId, transaction);
    if (!entry) {
      throw new NotFoundError('Journal entry not found');
    }
    ...
    const updateOptions = { where: { id, tenantId } };
    ...
    const updated = await journalEntryRepository.findByIdWithLines(id, tenantId, transaction);
