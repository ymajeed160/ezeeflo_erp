...
const posCashManagementRoutes = require('./routes/posCashManagementRoutes');
    ...
    return ApiResponse.success(res, {
      ...
      data: {
        ...
        endpoints: {
          ...
          posSessions: '/api/pos/sessions',
          posSales: '/api/pos/sales',
          posReturns: '/api/pos/returns',
          posCashMovements: '/api/pos/cash-movements',
        },
      },
    });
  }
...
const businessRoutes = [
  ...
  // POS Module Routes
  { path: '/api/pos/terminals', router: posTerminalRoutes },
  { path: '/api/pos/sessions', router: posSessionRoutes },
  { path: '/api/pos/sales', router: posSaleRoutes },
  { path: '/api/pos/returns', router: posReturnRoutes },
  { path: '/api/pos/cash-movements', router: posCashManagementRoutes },
];
