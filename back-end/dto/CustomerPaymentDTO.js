...
class CustomerPaymentDTO {
  ...
  static toCreate(body, tenantId, userId) {
    ...
    return {
      ...
      bankAccountRefId: body.bankAccountRefId || null,
  ...
  static toList(record) {
    return {
      ...
      cashAccountName: record.cashAccount ? `${record.cashAccount.code} - ${record.cashAccount.name}` : '',
      bankAccountRefId: record.bankAccountRefId || null,
  ...
  static toDetail(record) {
    return {
      ...
      bankAccountName: record.bankAccount ? `${record.bankAccount.code} - ${record.bankAccount.name}` : '',
      cashAccountId: record.cashAccountId || null,
      cashAccount: record.cashAccount ? { id: record.cashAccount.id, code: record.cashAccount.code, name: record.cashAccount.name } : null,
      bankAccountRefId: record.bankAccountRefId || null,
      paymentAccountId: record.paymentAccountId || null,
